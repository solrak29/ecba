...
Users.prototype.getRegisteredUsers = function getRegisteredUsers() {
    request('http://dev.asahitechnologies.com:4200/user',  function ( error, response, body ) {
        if ( error ) {
            console.log( "Received Error form mycoop web app " + error );
        } else {
            console.log( "Mycoop Response : " + response );
            console.log( "Mycoop Response : " + body );
        }
    });
}
